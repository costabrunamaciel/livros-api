...
Os testes ficam em [`cypress/e2e/`](https://github.com/costabrunamaciel/livros-api/tree/master/cypress/e2e) no repositório, um arquivo por requisito funcional (RF01–RF05), com os mesmos identificadores usados nos [[06 Casos de teste em Gherkin]].
...
---
Veja também: [[04 Plano de testes da API]] · [[06 Casos de teste em Gherkin]]
