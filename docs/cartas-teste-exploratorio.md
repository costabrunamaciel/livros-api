# CARTAS DE TESTE EXPLORATÓRIO — LIVROS API

| | |
|---|---|
| **Identificador do conjunto** | CH-LIVROS-API |
| **Origem** | Subprocesso ST04 — Testes exploratórios (ver [Plano de Testes PT-LIVROS-API-001](./plano-de-testes.md)) |
...
**Tempo total estimado:** 4h (compatível com a estimativa AT05 — Testes exploratórios do [Plano de Testes](./plano-de-testes.md)).
